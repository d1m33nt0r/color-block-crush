...
namespace Game.Scripts.UI.GameOver
{
    public class GameOverUI : MonoBehaviour, IGameOverUI
    {
        ...
        private void PlayShowAnimation()
        {
            ...
            {
                _showSequence.Append(FadeGraphic(_gameOverText, _textColor.a, _textDuration));
                _showSequence.Join(_gameOverText.transform
                    .DOScale(_textScale, _textDuration)
                    .SetEase(Ease.OutBack));
            }

            if (_buttonCanvasGroup != null && _restartButton != null)
            {
                ...
                _showSequence.Join(_restartButton.transform
        ...
        private void PrepareHiddenState()
        {
            ...
            SetGraphicAlpha(_gameOverText, 0f);
            ...
            if (_gameOverText != null)
            {
                _gameOverText.transform.localScale = _textScale * _hiddenScaleMultiplier;
            }
            ...
            if (_restartButton != null)
            {
                _restartButton.transform.localScale = _buttonScale * _hiddenScaleMultiplier;
            }
        }
        ...
        private void CacheState()
        {
            ...
            if (_gameOverText != null)
            {
                _textColor = _gameOverText.color;
                _textScale = _gameOverText.transform.localScale;
            }

            if (_restartButton != null)
            {
                _buttonCanvasGroup = _restartButton.GetComponent<CanvasGroup>();
                if (_buttonCanvasGroup == null)
                {
                    _buttonCanvasGroup = _restartButton.gameObject.AddComponent<CanvasGroup>();
                }
